...
<template>
  <div>
    <div style="position: fixed; z-index: 999; width:100%; height: 100%;left:0px; top:0px; background: #fff; text-align: center" >
      <img ref="loading" :src="require(`@/assets/images/logo/loading.svg`)" width="50">
    </div>
    <vue-html2pdf
      v-if="this.api !== false"
      :show-layout="false"
      ...
      :filename="`${api.data.name}_${(this.getTime(0, true)).replace(/:/gi, '-').replace(' ','_')}`"
      :pdf-quality="2"
      ...
      ref="html2Pdf"
      style="position: fixed; padding-left: 10px"
    >
    ...
    <!-- chart data -->
      <div class="chart-label">
        ...
        <div style="padding-left: 50px;width: 730px">
            <app-echart-line :option-data="chart" />
        </div>
      </div>
    </section>
    <!-- table heading -->
    <section slot="pdf-item" style="padding-left: 10px;">
    ...
    <!-- table data -->
      <table v-for="data1 in tableSplit1" width="750" border="1" cellspacing="0" cellpadding="0">
        <tr>
    ...
    <section v-for="data1 in tableSplit2" slot="pdf-content" style="padding-left: 10px;">
